...
# Force single-threaded BLAS in agent subprocesses. The referee measures CPU
# time via process_time(), which sums across all threads. Multi-threaded BLAS
# inflates this measurement and unfairly penalises agents that use numpy.
_SUBPROCESS_ENV = {
    **os.environ,
    "OMP_NUM_THREADS": "1",

...
from .coord import Coord, Direction, CARDINAL_DIRECTIONS
from .player import Player
from .board import Board, PlayerColor, CellState, CellMutation, BoardMutation, GamePhase
    ...
    try:
        ...
        async with p1:
            ...
            async with p2:
                ...
                while True:
                    # Check if game is already over (e.g. stalemate)
                    # before requesting an action from the player.
                    if board.game_over:
